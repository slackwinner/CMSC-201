...
MAXX=100
#gets an integer
def getValidInt(min,maxx):
    m="Enter an integer between"+minn+"and"+str(maxx)+"(inclusive):"#message to ask the user
    num=input(int(msg))
...
def main():
    ...
    #cp /afs/umbc.edu/users/k/k/k38/pub/cs201/less_broken.py lab09.py
main()
